...
<head>
    ...
    <script src="addons/jquery/jquery.dataTables.min.js"></script>
    <script src="addons/bootstrap/js/dataTables.bootstrap4.min.js"></script>
